...
contract Bitcoin3D is StandardToken {
    ...
    */
    uint256 whaleFunding = 30000000000000;
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    {
        balances[msg.sender] = reserved + whaleFunding;               // Give the creator all initial tokens (100000 for example)
        totalSupply = supply;                   // Update total supply (100000 for example)
